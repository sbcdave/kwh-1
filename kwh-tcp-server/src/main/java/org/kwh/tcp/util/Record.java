...
public class Record {
    ...
    private static String AD07channelLabel =System.getProperty("org.kwh.AD07.channel.label","Channel_AD07");
    private static String AD08channelLabel =System.getProperty("org.kwh.AD08.channel.label","Channel_AD08");
    private static String AD09channelLabel =System.getProperty("org.kwh.AD09.channel.label","Channel_AD09");
    private static String AD10channelLabel =System.getProperty("org.kwh.AD10.channel.label","Channel_AD10");
    ...
    private static String PU07channelLabel =System.getProperty("org.kwh.PU06.channel.label","Channel_PU07");
    private static String PU08channelLabel =System.getProperty("org.kwh.PU06.channel.label","Channel_PU08");
    ...
    private static Boolean AD07channelActive =Boolean.parseBoolean(System.getProperty("org.kwh.AD07.channel.active","true"));
    private static Boolean AD08channelActive =Boolean.parseBoolean(System.getProperty("org.kwh.AD08.channel.active","true"));
    private static Boolean AD09channelActive =Boolean.parseBoolean(System.getProperty("org.kwh.AD09.channel.active","true"));
    private static Boolean AD10channelActive =Boolean.parseBoolean(System.getProperty("org.kwh.AD10.channel.active","true"));
    ...
    private static Boolean PU07channelActive =Boolean.parseBoolean(System.getProperty("org.kwh.PU07.channel.active","true"));
    private static Boolean PU08channelActive =Boolean.parseBoolean(System.getProperty("org.kwh.PU08.channel.active","true"));
    ...
    static {
    	...
    	if (AD07channelActive) activeChannels.add("AD07");
    	if (AD08channelActive) activeChannels.add("AD08");
    	if (AD09channelActive) activeChannels.add("AD09");
    	if (AD10channelActive) activeChannels.add("AD10");
    	...
    	if (PU07channelActive) activeChannels.add("PU07");
    	if (PU08channelActive) activeChannels.add("PU08");
    }
